...
func main() {
	fmt.Println("Testing Itau Statement Parser")
	fmt.Println("==============================\n")

	// Open the Itau sample file
	filename := "sample_bank_statements/Estado_De_Cuenta_4724468.xls"
	...
	statement, err := ParseItauStatement(file)
	if err != nil {
